...
namespace Zidenyk\CustomWidget\Controller\Adminhtml\Conditions;
...
abstract class Rule extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $this->_setActiveMenu('Zidenyk_CustomWidget::universal')
    ...
    {
        return $this->_authorization->isAllowed('Zidenyk_CustomWidget::rules');
    }
}
