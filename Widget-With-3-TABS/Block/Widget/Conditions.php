...
namespace Zidenyk\CustomWidget\Block\Widget;
...
class Conditions extends Generic implements BlockInterface
{
    ...
    public function prepareElementHtml(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        $chooser = $this->getLayout()->createBlock(
            \Zidenyk\CustomWidget\Block\Widget\Chooser::class
        )->setElement(
            $element
        )->setConfig(
            $this->getConfig()
    ...
    protected function _prepareForm()
    {
        ...
        $buttonHtml = $this->getLayout()->createBlock(
            \Zidenyk\CustomWidget\Block\Widget\Options\ChooseButtonTemplateHandler::class
        )->setData(
            'cuttedName',
            $cuttedName
        )->setData(
